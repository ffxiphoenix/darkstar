...
NORMAL_MOB_MAX_LEVEL_RANGE_MIN = 77; -- Lower Bound of Max Level Range for Normal Mobs (0 = Uncapped)
NORMAL_MOB_MAX_LEVEL_RANGE_MAX = 79; -- Upper Bound of Max Level Range for Normal Mobs (0 = Uncapped)
...
ADVANCED_JOB_LEVEL = 20; -- Minimum level to accept advanced job quests.  Set to 0 to start the game with advanced jobs.
...
GIL_RATE   = 6.000; -- Multiplies gil earned from quests.  Won't always display in game.
...
RELIC_2ND_UPGRADE_WAIT_TIME = 295200;      -- wait time for 2nd relic upgrade (stage 2 -> stage 3) in seconds. 604800s = 1 RL week.
